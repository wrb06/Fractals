class Complex{
  ...
  public Complex minusComp(Complex num){
    return new Complex(Rel - num.Rel, Img - num.Img);
  }
  public Complex multComp(Complex num){
     return new Complex(Rel*num.Rel - Img*num.Img, Img*num.Rel + Rel*num.Img); 
  }
  public Complex divComp(Complex num){
    return new Complex ((Rel*num.Rel + Img*num.Img)/(num.Rel * num.Rel + num.Img * num.Img), (Img*num.Rel - Rel*num.Img)/(num.Rel * num.Rel + num.Img * num.Img));
  }
